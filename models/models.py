...
class Course(models.Model):
    _inherit = "kzm_crypt_field.record"
    ...
    code = fields.Char(compute='_compute_code',inverse='_inverse_code',default='', invisible=True, copy=False)
    code_crypt = fields.Char(string='Encrypted code', invisible=True, copy=False)
